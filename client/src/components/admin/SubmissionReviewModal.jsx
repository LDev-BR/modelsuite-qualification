      ...
      <div className="bg-bg-card border border-border rounded-xl w-full max-w-lg elevated-modal animate-modal-in"
        ...
        <div className="p-6 flex flex-col gap-5">
          <div className="bg-bg-surface rounded-lg px-4 py-3.5 border border-border">
            <p className="text-[11px] font-semibold uppercase tracking-[0.5px] text-text-faint mb-1.5 flex items-center gap-1.5">
          ...
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.5px] text-text-faint mb-2 flex items-center gap-1.5">
          ...
          <div className="flex gap-3 pt-1 border-t border-border mt-1">
            ...
            <button onClick={() => handleReview('Rejected')}
              className="flex-1 py-2.5 bg-danger/10 text-danger border border-danger/30 rounded-lg text-sm font-semibold cursor-pointer hover:bg-danger/20 transition-all font-sans inline-flex items-center justify-center gap-2">
              <AppIcon name="close" size={15} />
              Reject
            </button>
            <button onClick={() => handleReview('Approved')}
              className="flex-1 py-2.5 bg-success/10 text-success border border-success/30 rounded-lg text-sm font-semibold cursor-pointer hover:bg-success/20 transition-all font-sans inline-flex items-center justify-center gap-2">
