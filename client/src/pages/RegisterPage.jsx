...
const RegisterPage = () => {
  ...
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[480px_1fr]">
      ...
      {/* ── Right: Visual panel ── */}
      <div className="hidden lg:flex flex-col items-center justify-center relative overflow-hidden p-16 animate-fade-in min-h-screen auth-visual-panel"
        style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
        
        {/* Top Right Info Icon */}
        <div className="absolute top-12 right-12 group z-50">
          <div className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 cursor-help auth-info-button">
          ...
          {/* Tooltip Popup */}
          <div className="absolute right-0 top-14 w-[340px] p-6 rounded-2xl backdrop-blur-xl auth-tooltip opacity-0 translate-y-3 invisible group-hover:opacity-100 group-hover:translate-y-0 group-hover:visible transition-all duration-300">
            <h3 className="text-text-primary font-bold text-[15px] mb-4 font-display">Intern Selection Flow</h3>
            <ol className="flex flex-col gap-4 relative">
              {/* Vertical line */}
              <div className="absolute left-[9px] top-2 bottom-2 w-[2px] timeline-line rounded-full"></div>
              ...
              <li className="flex items-start gap-4 relative opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 delay-100">
                <div className="w-[20px] h-[20px] rounded-full timeline-dot timeline-dot-success flex-shrink-0 mt-0.5 relative z-10 animate-pulse"></div>
                <div>
                  <p className="text-[13px] font-semibold text-text-primary">1. Start Working</p>
              ...
              <li className="flex items-start gap-4 relative opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 delay-200">
                <div className="w-[20px] h-[20px] rounded-full timeline-dot timeline-dot-primary flex-shrink-0 mt-0.5 relative z-10 animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                <div>
                  <p className="text-[13px] font-semibold text-text-primary">2. Resolve & Push</p>
              ...
              <li className="flex items-start gap-4 relative opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 delay-300">
                <div className="w-[20px] h-[20px] rounded-full timeline-dot timeline-dot-violet flex-shrink-0 mt-0.5 relative z-10 animate-pulse" style={{ animationDelay: '0.4s' }}></div>
                <div>
                  <p className="text-[13px] font-semibold text-text-primary">3. Core Review</p>
